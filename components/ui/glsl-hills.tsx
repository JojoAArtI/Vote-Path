...
export function GLSLHills({
  ...
  useEffect(() => {
        ...
        return new THREE.Mesh(
          ...
          new THREE.RawShaderMaterial({
            ...
            fragmentShader: `
              ...
              void main(void) {
                float opacity = (96.0 - length(vPosition)) / 256.0 * 0.58;
                vec3 color = vec3(0.93, 0.96, 0.99);
    ...
    const resize = () => {
      ...
      const widthPx = Math.max(1, containerWidth);
      const heightPx = Math.max(1, containerHeight);
