...
export default function HomePage() {
  return (
    <div className="pb-16">
      ...
      <GsapReveal className="mx-auto mt-10 w-full max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid gap-4 lg:grid-cols-[1.05fr_0.95fr]">
          <article data-gsap-item className="rounded-[2rem] border border-slate-200 bg-white p-6 shadow-soft sm:p-8">
      ...
      <GsapReveal className="mx-auto mt-8 w-full max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid gap-4 rounded-[2rem] border border-slate-200 bg-white p-6 shadow-soft sm:grid-cols-3">
          {[
            ...
            <div key={item} data-gsap-item className="rounded-2xl bg-slate-50 p-4 ring-1 ring-slate-200">
      ...
      <GsapReveal className="mx-auto mt-8 w-full max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid gap-4 lg:grid-cols-3">
          <Link href="/assistant" data-gsap-item className="rounded-[2rem] border border-slate-200 bg-white p-6 shadow-soft transition hover:-translate-y-0.5 sm:p-8">
          ...
          <Link href="/timeline" data-gsap-item className="rounded-[2rem] border border-slate-200 bg-white p-6 shadow-soft transition hover:-translate-y-0.5 sm:p-8">
          ...
          <Link href="/map" data-gsap-item className="rounded-[2rem] border border-slate-200 bg-white p-6 shadow-soft transition hover:-translate-y-0.5 sm:p-8">
